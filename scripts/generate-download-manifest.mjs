#!/usr/bin/env node
// Generates a download manifest (manifest.json) from a directory of release
// assets. A release/download page can consume the manifest; keep its schema
// aligned with that consumer when changing fields or classification rules.
//
