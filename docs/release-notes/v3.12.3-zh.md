...
用户启用此功能即表示**自行承担所有风险**。Codex Switch 不对因使用此功能而导致的任何账号限制、警告或服务暂停承担责任。
...
| 文件                                       | 说明                                |
| ------------------------------------------ | ----------------------------------- |
| `CodexSwitch-v3.12.3-Windows.msi`            | **推荐** - MSI 安装包，支持自动更新 |
| `CodexSwitch-v3.12.3-Windows-Portable.zip`   | 便携版，解压即用，不写入注册表      |

### macOS

| 文件                               | 说明                                                      |
| ---------------------------------- | --------------------------------------------------------- |
| `CodexSwitch-v3.12.3-macOS.dmg`     | **推荐** - DMG 安装包，拖入 Applications 即可             |
| `CodexSwitch-v3.12.3-macOS.zip`     | 解压后拖入 Applications，Universal Binary                 |
| `CodexSwitch-v3.12.3-macOS.tar.gz`  | 用于 Homebrew 安装和自动更新                              |
