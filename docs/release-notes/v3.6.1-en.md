...
- Download `CodexSwitch-v3.6.1-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `CodexSwitch-v3.6.1-Windows.msi`
- **Portable**: `CodexSwitch-v3.6.1-Windows-Portable.zip`

#### Linux

- **AppImage**: `CodexSwitch-v3.6.1-Linux.AppImage`
- **Debian**: `CodexSwitch-v3.6.1-Linux.deb`
...
- **Customizable Storage Location** - Customize Codex Switch's configuration storage directory
...
Codex Switch is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
