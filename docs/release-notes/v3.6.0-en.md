...
- Download `CodexSwitch-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `CodexSwitch-v3.6.0-Windows.msi`
- **Portable**: `CodexSwitch-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `CodexSwitch-v3.6.0-Linux.AppImage`
- **Debian**: `CodexSwitch-v3.6.0-Linux.deb`
