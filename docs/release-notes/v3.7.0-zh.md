...
Codex Switch v3.7.0 新增六大核心功能，新增超过 18,000 行代码。
...
- **Windows**：`CodexSwitch-v3.7.0-Windows.msi` 或 `-Portable.zip`
- **macOS**：`CodexSwitch-v3.7.0-macOS.tar.gz` 或 `.zip`
- **Linux**：`CodexSwitch-v3.7.0-Linux.AppImage` 或 `.deb`
