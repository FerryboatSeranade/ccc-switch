# Codex Switch v3.16.3

> 🎉 **Codex Switch has passed 100,000 Stars!**
...
| File                                     | Description                                      |
| ---------------------------------------- | ------------------------------------------------ |
| `CodexSwitch-v3.16.3-Windows.msi`          | **Recommended** - MSI installer with auto-update |
| `CodexSwitch-v3.16.3-Windows-Portable.zip` | Portable build, unzip and run                    |

### macOS

| File                             | Description                                           |
| -------------------------------- | ----------------------------------------------------- |
| `CodexSwitch-v3.16.3-macOS.dmg`    | **Recommended** - DMG installer, drag to Applications |
| `CodexSwitch-v3.16.3-macOS.zip`    | Unzip and drag to Applications, Universal Binary      |
| `CodexSwitch-v3.16.3-macOS.tar.gz` | For Homebrew install and auto-update                  |
...
- `CodexSwitch-v3.16.3-Linux-x86_64.AppImage` / `.deb` / `.rpm`
- `CodexSwitch-v3.16.3-Linux-arm64.AppImage` / `.deb` / `.rpm`
