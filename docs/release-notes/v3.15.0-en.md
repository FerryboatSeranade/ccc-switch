...
**[Use Codex Switch to configure, manage, and switch Claude Desktop providers in one place](../user-manual/en/2-providers/2.6-claude-desktop.md)**
...
Codex Switch now treats **Claude Desktop** as a first-class managed surface alongside Claude Code / Codex / Gemini / OpenCode / OpenClaw / Hermes.

- New dedicated Claude Desktop panel that brokers third-party providers to Claude Desktop through Codex Switch's in-app proxy gateway
...
ChatGPT Codex providers no longer rely on a hardcoded model selection — Codex Switch fetches a **live model list** from the ChatGPT backend on demand.
...
Switching a Claude Desktop provider writes Codex Switch's managed 3P profile and **requires restarting Claude Desktop** to take effect; proxy-mode providers require Codex Switch's Local Routing to stay running while in use.
...
### Codex Switch Brand Surface Unified to trusted release channel
...
| File                                     | Description                                           |
| ---------------------------------------- | ----------------------------------------------------- |
| `CodexSwitch-v3.15.0-Windows.msi`          | **Recommended** - MSI installer, supports auto-update |
| `CodexSwitch-v3.15.0-Windows-Portable.zip` | Portable, extract and run, no registry writes         |

### macOS

| File                             | Description                                             |
| -------------------------------- | ------------------------------------------------------- |
| `CodexSwitch-v3.15.0-macOS.dmg`    | **Recommended** - DMG installer, drag into Applications |
| `CodexSwitch-v3.15.0-macOS.zip`    | Extract and drag into Applications, Universal Binary    |
| `CodexSwitch-v3.15.0-macOS.tar.gz` | For Homebrew installation and auto-update               |
...
>
> - `CodexSwitch-v3.15.0-Linux-x86_64.AppImage` / `.deb` / `.rpm`
> - `CodexSwitch-v3.15.0-Linux-arm64.AppImage` / `.deb` / `.rpm`
