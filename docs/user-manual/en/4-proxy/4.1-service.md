...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (CCodex Switch)
...
After starting the proxy and enabling app takeover, CCodex Switch modifies app configurations:
...
When stopping the proxy, CCodex Switch will:
