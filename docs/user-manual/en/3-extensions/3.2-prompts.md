...
CCodex Switch provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
cccccswitch://import/prompt?data=<base64-encoded preset>
```
