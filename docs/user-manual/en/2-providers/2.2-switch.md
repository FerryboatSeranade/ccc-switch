...
2. CCodex Switch updates the configuration file
...
1. Right-click the CCodex Switch icon in the system tray
...
When switching providers, CCodex Switch modifies the following files:
