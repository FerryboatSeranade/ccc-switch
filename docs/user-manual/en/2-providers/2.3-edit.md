...
CCodex Switch provides rich icon customization features:
...
This ensures CCodex Switch and CLI tool configurations stay in sync.
...
When adding a provider, CCodex Switch automatically extracts endpoint URLs from the configuration.
