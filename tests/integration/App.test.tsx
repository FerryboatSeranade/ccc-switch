...
describe("App integration with MSW", () => {
  beforeEach(() => {
    ...
    localStorage.removeItem("ccc-switch-last-view");
    localStorage.setItem("ccc-switch-last-app", "claude");
  });
  ...
  it("warns without blocking when removing Pi's global default provider", async () => {
    localStorage.setItem("ccc-switch-last-app", "pi");
    setProviders("pi", {
      custom: {
        id: "custom",
        name: "Custom Pi",
  ...
  it("hosts the Skills check-update action in the App toolbar", async () => {
    localStorage.setItem("ccc-switch-last-view", "skills");
    const { default: App } = await import("@/App");
    renderApp(App);
